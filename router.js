...
const routes = [
  ...
  {path: '/register', name: 'register', component: page('auth/register.vue')},
  {
    ...
    name: 'verify', component:
      page('auth/verification/verify.vue')
  },
  {
    path: '/verification/resend',
    name: 'verification.resend', component:
      page('auth/verification/resend.vue')
  },
  {
    path: '/password/reset/:token',
    name: 'password-reset', component:
      page('auth/password/password-reset.vue')
  },
  {
    path: '/password/email',
  ...
  {
    path: '/designs/',
    name: 'designs-search', component:
      page('designs/search.vue')
  },
  {
    path: '/design/:slug',
    name: 'designs-show', component:
      page('designs/show.vue')
  },
